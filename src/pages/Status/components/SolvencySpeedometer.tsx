...
const STEP_PHASE_MSG: Record<DefenseStep, MessageDescriptor> = {
  ...
  4: msg`Phase 2 · Internal Defense`,
  5: msg`Phase 2 · Internal Defense`,
  6: msg`Phase 2 · Internal Defense`,
  7: msg`Phase 2 · Internal Defense`,
  8: msg`Phase 3 · Last Resort`,
  9: msg`Phase 3 · Last Resort`,
};
