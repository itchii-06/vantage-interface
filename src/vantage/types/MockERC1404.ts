...
export interface MockERC1404Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "RESTRICTED"
  ...
  encodeFunctionData(functionFragment: "restrict", values: [AddressLike]): string;
...
export interface MockERC1404 extends BaseContract {
  connect(runner?: ContractRunner | null): MockERC1404;
  waitForDeployment(): Promise<this>;

  interface: MockERC1404Interface;
  ...
  RESTRICTED: TypedContractMethod<[], [bigint], "view">;
  ...
  detectTransferRestriction: TypedContractMethod<
    [arg0: AddressLike, to: AddressLike, arg2: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  restrict: TypedContractMethod<[user: AddressLike], [void], "nonpayable">;
  ...
  getFunction(nameOrSignature: "RESTRICTED"): TypedContractMethod<[], [bigint], "view">;
  getFunction(nameOrSignature: "SUCCESS"): TypedContractMethod<[], [bigint], "view">;
  getFunction(nameOrSignature: "allow"): TypedContractMethod<[user: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  ): TypedContractMethod<[arg0: AddressLike, to: AddressLike, arg2: BigNumberish], [bigint], "view">;
  ...
  getFunction(
    ...
    "nonpayable"
  >;
  getFunction(nameOrSignature: "restrict"): TypedContractMethod<[user: AddressLike], [void], "nonpayable">;
