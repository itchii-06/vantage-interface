...
const _abi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract IVantageNavOracle",
        name: "",
        type: "address",
      },
    ],
...
export class VantageNftVault__factory {
