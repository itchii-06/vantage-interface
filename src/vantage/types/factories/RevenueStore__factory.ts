...
import type { RevenueStore, RevenueStoreInterface } from "../RevenueStore";
...
export class RevenueStore__factory {
  static readonly abi = _abi;
  static createInterface(): RevenueStoreInterface {
    return new Interface(_abi) as RevenueStoreInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): RevenueStore {
    return new Contract(address, _abi, runner) as unknown as RevenueStore;
  }
}
