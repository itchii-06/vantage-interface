...
const _abi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "exchangeRateAtTime",
        type: "uint256",
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "neededPrincipal",
        type: "uint256",
      },
    ],
  ...
  },
  {
    ...
    name: "RecoveryConversionExecuted",
    type: "event",
  },
  {
    anonymous: false,
    ...
    name: "RecoveryConversionProposed",
    type: "event",
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    name: "executeRecoveryConversion",
    outputs: [
      {
        internalType: "uint256",
        name: "usdcReceived",
  ...
  },
  {
    ...
    name: "proposeRecoveryConversion",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  },
  {
    ...
    name: "setWithdrawalRatioLockBps",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
...
export class TrancheVault__factory {
  ...
  static connect(address: string, runner?: ContractRunner | null): TrancheVault {
