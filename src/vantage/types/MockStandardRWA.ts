...
export interface MockStandardRWAInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface MockStandardRWA extends BaseContract {
  connect(runner?: ContractRunner | null): MockStandardRWA;
  waitForDeployment(): Promise<this>;

  interface: MockStandardRWAInterface;
