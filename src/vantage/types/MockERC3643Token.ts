...
export interface MockERC3643TokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface MockERC3643Token extends BaseContract {
  connect(runner?: ContractRunner | null): MockERC3643Token;
  waitForDeployment(): Promise<this>;

  interface: MockERC3643TokenInterface;
  ...
  setIdentityRegistry: TypedContractMethod<[reg: AddressLike], [void], "nonpayable">;
  ...
  getFunction(nameOrSignature: "setIdentityRegistry"): TypedContractMethod<[reg: AddressLike], [void], "nonpayable">;
