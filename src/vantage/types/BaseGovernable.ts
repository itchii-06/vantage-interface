...
export interface BaseGovernableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "acceptOwnershipOf"
...
export interface BaseGovernable extends BaseContract {
  connect(runner?: ContractRunner | null): BaseGovernable;
  waitForDeployment(): Promise<this>;

  interface: BaseGovernableInterface;
