...
export interface VantagePositionBridgeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "GOVERNOR_ROLE"
...
export namespace PositionClosedEvent {
  export type InputTuple = [positionKey: BytesLike, orderBook: AddressLike];
  export type OutputTuple = [positionKey: string, orderBook: string];
...
export interface VantagePositionBridge extends BaseContract {
  connect(runner?: ContractRunner | null): VantagePositionBridge;
  waitForDeployment(): Promise<this>;

  interface: VantagePositionBridgeInterface;
  ...
  ORDER_BOOK_ROLE: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "handlePositionOpen"
  ): TypedContractMethod<
    [
      positionKey: BytesLike,
      nftContract: AddressLike,
  ...
  filters: {
    ...
    "PositionOpened(bytes32,address)": TypedContractEvent<
      PositionOpenedEvent.InputTuple,
      PositionOpenedEvent.OutputTuple,
      PositionOpenedEvent.OutputObject
    >;
