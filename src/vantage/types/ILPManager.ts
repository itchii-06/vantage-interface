...
export interface ILPManagerInterface extends Interface {
...
export interface ILPManager extends BaseContract {
  connect(runner?: ContractRunner | null): ILPManager;
  waitForDeployment(): Promise<this>;

  interface: ILPManagerInterface;
