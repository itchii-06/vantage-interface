...
export interface VantageRewardRouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "FEE_MANAGER_ROLE"
...
export namespace FeeManagerUpdatedEvent {
  export type InputTuple = [manager: AddressLike, enabled: boolean];
  export type OutputTuple = [manager: string, enabled: boolean];
...
export interface VantageRewardRouter extends BaseContract {
  connect(runner?: ContractRunner | null): VantageRewardRouter;
  waitForDeployment(): Promise<this>;

  interface: VantageRewardRouterInterface;
  ...
  getEvent(
    ...
    FeeManagerUpdatedEvent.InputTuple,
    FeeManagerUpdatedEvent.OutputTuple,
    FeeManagerUpdatedEvent.OutputObject
  >;
  getEvent(
    key: "FeesDistributed"
  ): TypedContractEvent<
  ...
  filters: {
    "FeeManagerUpdated(address,bool)": TypedContractEvent<
      ...
      FeeManagerUpdatedEvent.OutputObject
    >;
    FeeManagerUpdated: TypedContractEvent<
      FeeManagerUpdatedEvent.InputTuple,
      FeeManagerUpdatedEvent.OutputTuple,
      FeeManagerUpdatedEvent.OutputObject
    >;
